...
$sala = $salaController->getSala($id);
?>
...
<html>
    ...
    <div class="modal fade" id="voltar-modal" tabindex="-1" role="dialog">
        ...
        <div id="main" class="container ">
            ...
            <h3 style="text-align: center">Alterar Cadastro de Sala</h3>
            ...
            <form id="form-sala" method="post" >
                ...
                <div class="panel panel-default" >
                    <div class="panel-body">
                            ...
                            <input type="hidden" id="auxiliar" value="<?php echo $sala->getDsMaquina(); ?>">
                            <div class="form-group col-xs-12 col-md-12 col-md-12 col-lg-12">
                                <label for="maquina">M&aacute;quina</label>
                                <input  id="maquina" placeholder="M&aacute;quina" class="form-control" value="<?php echo $sala->getDsMaquina(); ?>" required="">
                            </div>
                            <div class="row"></div>
                            <div class="form-group col-xs-12 col-md-12 col-md-12 col-lg-12">
                                <label for="sala">Consult&oacute;rio / Sala</label>
                                <input  id="sala" placeholder="Consult&oacute;rio / Sala" class="form-control" value="<?php echo $sala->getDsConsultorio(); ?>" required="">
                            </div>
